...
export default function AdminDashboard() {
  ...
  // ==========================================================
  // GENERADORES DE PDF FUTURISTAS (NUEVO CÓDIGO)
  // ==========================================================

  // Limpieza del @lid y @c.us
  ...
  // Generador QR Nativo en Canvas para evitar bloqueos
  ...
  const generarPDFIngreso = async (cita: any) => {
    ...
    doc.setFillColor(8, 15, 30); // Fondo Oscuro
  ...
  return (
    <main className="min-h-screen bg-[#030712] text-white p-4 md:p-8 font-sans selection:bg-cyan-500 relative">
      ...
      <div className="max-w-[1400px] mx-auto relative z-10">
        ...
        {/* ... (Las demás pestañas analiticas y configuraciones permanecen igual en HTML) ... */}
